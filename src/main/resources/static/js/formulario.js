...
btnCrear.addEventListener("click", function (event) {
    ...
    let validacionCampoCategoriaFuction = validacionCategoria();
    ...
    if (validacionCampoNombreFuction == true && validacionCampoPrecioFuction == true &&
        ...
        && validacionCampoStockFuction == true && validacionCampoImagenFuction == true && validacionCampoCategoriaFuction == true) {
            ...
            fetch(URL_MAIN, {
                ...
                .then(productos => {
                    ...
                    if (productoExistente) {
                        ...
                        CampoCategoria.style.border = "solid thin red";
    ...
    function validacionCategoria() {
        if (CampoCategoria.value == "Selecciona una categoria") {
            CampoCategoria.style.border = "solid thin red";
            Nombre += "<li>Selecciona una categoria.</li>";
            alertError.style.display = "block";
            return false;
        } else {
            CampoCategoria.style.border = "solid thin green";
            return true;
        }
    }
